#include "GELULayer.h"
#include "CuCommon.h"
GELULayer::GELULayer(const int batchSize, const int channels, const int height, const int width, std::string layerName) : batchSize_(batchSize), outC_(channels), outHeight_(height), outWidth_(width){
