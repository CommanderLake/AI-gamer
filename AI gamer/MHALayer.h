...
public:
	...
	MultiHeadAttentionLayer(cudnnHandle_t cudnnHandle, cublasHandle_t cublasHandle,
							int batchSize, int seqLength, int embedSize, int numHeads,
							const char* layerName, bool train);
...
private:
	...
	float *m_Wq_, *v_Wq_, *m_Wk_, *v_Wk_, *m_Wv_, *v_Wv_, *m_Wo_, *v_Wo_;
	int t_ = 1;
