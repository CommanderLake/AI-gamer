...
void LoadBatch(StateBatch* batch, int batchSize, int frameStateSize, int framesPerSample, bool validation);
void LoadBatchFromVector(const std::vector<StateSingle*>& states, StateBatch* batch, int batchSize, int frameStateSize, int framesPerSample);
