...
ResizeLayer::ResizeLayer(const int batchSize, const int channels, const int inHeight, const int inWidth, const int outHeight, const int outWidth, const char* layerName, const bool train)
