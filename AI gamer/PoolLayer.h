...
public:
	PoolLayer(cudnnHandle_t cudnnHandle, cudnnPoolingMode_t mode, int batchSize, int channels, int* height, int* width, int poolSize, int stride, const char* layerName, bool train);
	~PoolLayer() override;
